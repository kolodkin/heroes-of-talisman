...
export const SwordIcon = ({ size, color, fill }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-icon-sword>
    <path
      d="M14.5 17.5L3 6V3h3l11.5 11.5M12 12L6 18M3 3l3.5 3.5"
      stroke={color}
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path d="M19 5l-2 2m2-2l2 2m-4 0l2 2" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path
      d="M8 16l-2 2m0 0l-2 2m2-2l2 2m-2-2l-2-2"
      stroke={color}
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
